...
class TestGenerateSingleFileDescription:
    ...
    def test_generates_description_with_device_and_time(self) -> None:
        """기기 정보와 촬영 시간이 있는 경우."""
        result = generate_single_file_description(device="iPhone 17 Pro Max", shot_time="14:30:00")
    ...
    def test_generates_description_with_device_only(self) -> None:
        """기기 정보만 있는 경우."""
        result = generate_single_file_description(device="Nikon Z8", shot_time=None)
    ...
    def test_generates_description_with_time_only(self) -> None:
        """촬영 시간만 있는 경우."""
        result = generate_single_file_description(device=None, shot_time="09:15:30")
    ...
    def test_returns_empty_for_no_metadata(self) -> None:
        ...
        result = generate_single_file_description(device=None, shot_time=None)

        assert result == ""

    def test_skips_unknown_device(self) -> None:
        """Unknown 기기는 표시하지 않음."""
        result = generate_single_file_description(device="Unknown", shot_time="10:00:00")
    ...
    def test_skips_empty_shot_time(self) -> None:
        ...
        result = generate_single_file_description(device="GoPro Hero 13", shot_time="")
